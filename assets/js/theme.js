...
function applyTheme(theme, mode) {
  ...
  try {
    localStorage.setItem('mctoolkit-theme', theme);
    localStorage.setItem('mctoolkit-mode', mode);
...
function updateModeToggle(mode) {
  ...
  btn.setAttribute('aria-label', mode === 'dark' ? t('controls.modeToLight') : t('controls.modeToDark'));
